...
class TestUtilities(unittest.TestCase):
    ...
    @unittest.skipIf(len(glob.glob("../assets/testing/test_img*.png")) != 1,
    ...
    def test_augment_img_set(self):
        ...
        utility.augment_img_set("../assets/testing/")
        img_count = len([1 for file in glob.glob("../assets/testing/test_img*.png")])
